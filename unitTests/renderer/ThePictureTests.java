...
public class ThePictureTests {
    ...
    public void My_picture() {
        ...
        scene.geometries.add(
                ...
                new Sphere(12, new Point(-6989, 350, 615))
        ...
        scene.setLights(
                new SpotLight(new Color(700, 300, 500), new Point(1000, 200, 750), new Vector(-2, 0, -0.5))
                        .setNarrowBeam(400).setkL(0.0003).setkQ(0.000001),
                new PointLight(new Color(500, 300, 300), new Point(-3000, -300, 1100))
                        .setkL(0.0003).setkQ(0.000001),
                new PointLight(new Color(500, 300, 300), new Point(-3000, 0, 1100))
                        .setkL(0.0003).setkQ(0.000001),
                new PointLight(new Color(500, 300, 300), new Point(-3000, 300, 1100))
                        .setkL(0.0003).setkQ(0.000001),
